...
//       // Process the data into daily, weekly, monthly, and yearly counts
//       const now = new Date();
...
//         if (orderDay === today) dailyCount++;
//         if (orderYear === currentYear) yearlyCount++;
//         if (orderMonth === currentMonth && orderYear === currentYear) monthlyCount++;
//         if (orderWeek === currentWeek && orderYear === currentYear) weeklyCount++;
//       });
  
//       // Update state with new transaction counts
...
//   return (
//     <div className="w-full h-full text-white space-y-8">
//       {/* Header Section */}
...
//             </div>
//             <h1 className="text-gray-100 text-3xl"> {USERS ? USERS.length : <Spinner color="white" /> } </h1>
//           </div>
...
//             </div>
//             <h1 className="text-gray-100 text-3xl"> {orders ? orders.length : <Spinner color="white" /> } </h1>
//           </div>
